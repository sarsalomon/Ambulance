...
import { getCar, updateCar } from '../../../http/managerAPI';
import { Context } from '../../..';
import { MANAGER_CAR_ROUTE } from '../../../utils/consts';
import { Link } from 'react-router-dom';


const CarUpdate = observer(() => {
    ...
    const UpdateData = async () => {
        try{
            ...
            data = await updateCar(formData).then(data => {
                setTitle(title);
            });
            toast.info(`Moshina yangilandi`, {
