...
import { getDisease, updateDisease } from '../../../http/managerAPI';
import { Context } from '../../..';
import { MANAGER_DISEASE_ROUTE } from '../../../utils/consts';
import { Link } from 'react-router-dom';


const DiseaseUpdate = observer(() => {
    ...
    const UpdateData = async () => {
        try{
            ...
            data = await updateDisease(formData).then(data => {
                setTitle(title);
            });
            toast.info(`Kasallik yangilandi`, {
        ...
        <div>
            ...
            <Container>
                <span className='d-flex justify-content-between'>
                    ...
                    <h2 className='text-center'>Kasallikni Yangilash</h2>
                    <span></span>
                </span>
                    ...
                    <Row>
                        <Col>
                            <Form.Group className="mb-3">
                                <Form.Label>Kasallik Toifa nomi</Form.Label>
                                <Form.Control
                                    type='text'
                                    placeholder='Yurak'
                                    value={title}
