...
import { getFloor, updateFloor } from '../../../http/managerAPI';
import { Context } from '../../..';
import { MANAGER_FLOOR_ROUTE } from '../../../utils/consts';
import { Link } from 'react-router-dom';


const FloorUpdate = observer(() => {
    ...
    const UpdateData = async () => {
        try{
            ...
            data = await updateFloor(formData).then(data => {
                setTitle(title);
            });
            toast.info(`Qavat yangilandi`, {
        ...
        <div>
            ...
            <Container>
                <span className='d-flex justify-content-between'>
                    ...
                    <h2 className='text-center'>Qavatni Yangilash</h2>
                    <span></span>
                </span>
